...
Example: mid-sized carrier with 20 vehicles and 5,000 routes/month.

| Metric 		 | Value                                  |
|----------------|----------------------------------------|
| ARPU 	         | $299 + (5,000 × $0.08) = $699/month    |
| COGS           | ~$100/month infrastructure and support |
| Gross margin   | ~85%                                   |
| CAC 		     | ~$200                                  |
...
| ARPU 							| $300/month |
| Disputes closed without legal | 100%       |
| NPS 							| Above 40   |
...
LogiQED provides the cryptographic evidence layer for this transition.

## Long-Term

- eFTI compliance tooling.
- Insurance API integrations.
- Marketplace on top of trust graph.
