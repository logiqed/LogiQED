...
Sensor/device, attestation, timestamp, signature, provenance, claim, proof, Evidence Package.
...
E0–E5. Graded confidence for every source. A signature does not make a source trustworthy.

### Evidence Graph

Provenance DAG connecting events, sources and rules.
