...
Proves the cold chain was maintained for the entire trip. Temperature claims use Evidence Package Base with claim level E4 when the sensor is attested.
...
| Temperature Log | Continuous signed log, Evidence Package Base | Receiver, insurance |
...
For a route with a temperature claim, the Evidence Package Base is anchored and the temperature log is part of the Claim Evidence Root.
...
| Dispute resolution: $200–500 | $0.08 (Evidence Package Full closes dispute) | $200–500 |
...
1. Should Border Ready Pack be a separate product or a feature of Evidence Packages?
...
| Border Summary | Evidence Package Base, canonicalization | New template, no new logic |
